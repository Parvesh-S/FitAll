...
public func getDietFromUserDefaults() -> String {
    let userDiet = UserDefaults.standard.string(forKey: "diet")!
...
public func getIndexOfCurrentDiet() -> Int {
    let userDiet = UserDefaults.standard.string(forKey: "diet")!
    let diets = ["Omnivore", "Gluten Free", "Ketogenic", "Vegetarian", "Lacto-Vegetarian", "Ovo-Vegetarian", "Vegan", "Pescetarian", "Paleo", "Primal", "Whole30"]
